...
Alternatively, new entries (e.g. for a new microscope) can be specified by selecting `* New microscope *` from the drop-down selection, and providing a new name accordingly.
...
Light source power measurements can be via file currently implemented for 2 specific use-cases:
