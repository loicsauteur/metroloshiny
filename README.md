...
Supported are only integer light power percentages. Floating point numbers will be rounded..
...
- add a tag
- push
Follow the re-install instructions above; (local pixi env update is **not** necessary for the push to server)
-->
